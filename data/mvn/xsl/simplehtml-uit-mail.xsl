...
<xsl:param name="greyabbr">yes</xsl:param>    
    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <div>
                    Teksten: 
                    <xsl:apply-templates select="/tei:MVN/tei:text[1]/tei:group[1]//tei:text" mode="link"/>
                    <hr/>
                    Foliumzijden: 
    ...
    <xsl:template match="tei:head[not(ancestor::tei:p)]">
        <p title="head">
            <xsl:apply-templates/>
        </p>
    </xsl:template>
...
-->                        <xsl:when test="@n">
    ...
    <xsl:template match="tei:text[count(ancestor::tei:text)=1]">
        <div class="text">
            ...
            Tekst <xsl:value-of select="substring-after(@xml:id,$sigle)"/> 
            <xsl:apply-templates/>
        </div>
    </xsl:template>
    ...
    <xsl:template match="tei:text" mode="link">
        <a>
